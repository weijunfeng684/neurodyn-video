"""
2D PCA of last GRU hidden states for the ResNet-feature model (test split).

Checkpoint and feature root come from train_gru_resnet / extract_resnet_features.
"""
import numpy as np
import torch
...
def main() -> None:
    ...
    plot_hidden_embedding_scatter(
        ...
        CLASS_NAMES,
        OUTPUT_DIR / "hidden_pca_resnet.png",
        title="Last GRU hidden state (PCA)\nResNet frame features · test split",
    )
