"""
Train / val / test loop for GRUClassifier on handcrafted feature sequences.

Data layout: see extract_features.py output. Checkpoint + curves land in outputs/.
Val accuracy gates the saved weights; test block reloads best val checkpoint.
"""
...
def plot_curves(train_losses, val_losses, train_accs, val_accs):
    # npz lets refresh_output_figures.py redraw curves without rerunning epochs.
    ...
    plot_training_curves(
        ...
        metrics_cache=cache_dir / "baseline_training.npz",
    )
...
def main():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), OUTPUT_DIR / "best_gru_classifier.pt")
